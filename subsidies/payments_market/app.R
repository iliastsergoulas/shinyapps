...
mydata<-read.csv("./paymentstest.csv", sep=",", encoding="UTF-8", stringsAsFactors = FALSE)
...
header <- dashboardHeader(title = "Πορεία Μέτρων Αγοράς", titleWidth=600) # Header of dashboard
