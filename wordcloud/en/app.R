...
myDtm <- TermDocumentMatrix(myCorpus, control = 
            list(removePunctuation = TRUE, 
                 stopwords = c("agronewsgr","για","και","από","των", "οι", "...","ώστε","μέσα", "αυτά","περίπου",
                               ...
                               "xhnews","review", "agrocapital", "honda","civic","cor","bryanndyaguma","katrinasasse","aislisbon","tobloc",stopwords("english")),
...
png("/srv/shiny-server/shinyapps/wordcloud/twitterclouden.png", width=600,height=600)
