# Data: Agricultural irrigated land (% of total agricultural land)
# This R script is created as a Shiny application processing raw data downloaded from World Bank through WDI package, 
# and creating plots and maps as WDI(country = "all", indicator = "AG.LND.IRIG.AG.ZS", extra = FALSE, cache = NULL)
...
mydata <- dbGetQuery(con, "SELECT * from agriculture.agri_irrigated_land_wb_country") # Get data
dbDisconnect(con)
dbUnloadDriver(drv)
