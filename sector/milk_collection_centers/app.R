...
names(plants)<-c("Κωδικός έγκρισης","Ονομασία","Τοποθεσία","Περιφερειακή Ενότητα","Δραστηριότητα")

header <- dashboardHeader(title = "Κέντρα συλλογής γάλακτος", titleWidth=700) # Header of dashboard
sidebar <- dashboardSidebar(disable = TRUE)# Disabling sidebar of dashboard
frow1 <- fluidRow( # Creating row of valueboxes
    leafletOutput("map_points")
)
frow2 <- fluidRow(# Creating row of diagram and summary
    title = "Στοιχεία κέντρων",
    status="success",
    collapsible = TRUE,
