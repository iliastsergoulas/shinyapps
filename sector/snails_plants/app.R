...
plants <- readShapePoints("/home/iliastsergoulas/Dropbox/Website/shapefiles/snails/snails.shp")
...
header <- dashboardHeader(title = "Μονάδες τυποποίησης και συσκευασίας σαλιγκαριών", titleWidth=500) # Header of dashboard
