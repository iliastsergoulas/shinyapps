# Data: Production from aquaculture excluding hatcheries and nurseries (from 2008 onwards) 
...
# and creating plots and maps as get_eurostat("fish_aq2a", time_format = "raw")
...
mydata <- dbGetQuery(con, "SELECT * from agriculture.aquaculture_eu_country") # Get data
dbDisconnect(con)
dbUnloadDriver(drv)
...
header <- dashboardHeader(title = "Παραγωγή από υδατοκαλλιέργειες (2008-)", titleWidth=500) # Header of dashboard
