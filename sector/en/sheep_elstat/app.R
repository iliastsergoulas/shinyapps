...
header <- dashboardHeader(title = "Sheep in Greece", titleWidth=500) # Header of dashboard
...
frow2 <- fluidRow( # Creating row of two diagrams
    box(
        title = "Sheep population per category",
        status="success",
        collapsible = TRUE,
    ...
    box(
        title = "Sheep population per Region",
        status="success",
        collapsible = TRUE,
        theme = shinytheme("spacelab"), 
        mainPanel(
...
frow3 <- fluidRow( # Creating row of two diagrams
    box(
        title = "Temporal analysis of sheep population structure",
        status="success",
        collapsible = TRUE,
        theme = shinytheme("spacelab"), 
        mainPanel(
...
server <- function(input, output) {
    ...
    output$topyear <- renderValueBox({ # Filling valuebox
        valueBox(
            ...
            "Year with maximum sheep population",
            icon = icon("globe"),
            color = "olive")
    })
