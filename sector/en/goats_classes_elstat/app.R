...
header <- dashboardHeader(title = "Holdings per goats population class in Greece", titleWidth=650) # Header of dashboard
...
frow3 <- fluidRow( # Creating row of two diagrams
    box(
        title = "Temporal analysis of goats holdings structure",
        status="success",
        collapsible = TRUE,
        theme = shinytheme("spacelab"), 
        mainPanel(
