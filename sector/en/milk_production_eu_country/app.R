...
# and creating plots and maps as get_eurostat("apro_mk_farm", time_format = "raw")
...
mydata <- dbGetQuery(con, "SELECT * from agriculture.milk_production_eu_country") # Get data
dbDisconnect(con)
dbUnloadDriver(drv)
